    ...
    return (
      <div className="About page">
        ...
        <div className="section">
          ...
          <div className="description">Your product should be released as soon as it{"'"}s lovable and simple -- then it
        ...
        <div className="section">
          ...
          <div className="description">
            ...
            {' + '}
            <a
              href="https://steveblank.com/2015/05/06/build-measure-learn-throw-things-against-the-wall-and-see-if-they-work/"
            >
              Build Measure Learn
            </a>
            .
